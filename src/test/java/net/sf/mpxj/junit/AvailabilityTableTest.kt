 ...
 */
class AvailabilityTableTest {
    /**
     * Test the getEntryByDate method.
     */
    @Test
    @Throws(Exception::class)
    fun testGetEntryByDate() {
        val df = SimpleDateFormat("dd/MM/yyyy HH:mm")
        val availability1 = Availability(df.parse("01/02/2015 08:00"), df.parse("03/02/2015 17:00"), null)
        val availability2 = Availability(df.parse("01/03/2015 08:00"), df.parse("03/03/2015 17:00"), null)
        val table = AvailabilityTable()
