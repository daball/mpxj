 ...
 */
@RunWith(Suite::class)
@Suite.SuiteClasses(BasicTest::class, LocaleTest::class, ProjectCalendarTest::class, SplitTaskTest::class, MppGraphIndTest::class, SlackTest::class, MppProjectPropertiesTest::class, MppTaskTest::class, MppResourceTest::class, MppSubprojectTest::class, MppViewTest::class, MppFilterTest::class, MppAutoFilterTest::class, MppViewStateTest::class, MppGroupTest::class, MppCalendarTest::class, MppEnterpriseTest::class, MppBaselineTest::class, MppEmbeddedTest::class, MppRecurringTest::class, MppNullTaskTest::class, ProjectWriterUtilityTest::class, PlannerCalendarTest::class, PlannerResourceTest::class, TimephasedTest::class, DurationTest::class, MppFilterLogicTest::class, CostRateTableTest::class, AvailabilityTest::class, MppColumnsTest::class, MppBarStyleTest::class, MppGanttTest::class, TimephasedSegmentTest::class, MppAssignmentTest::class, TimephasedSegmentTest2::class, MppTaskFlags::class, MppResourceFlags::class, DateUtilityTest::class, DeletedAssignmentTest::class, MppResourceTypeTest::class, TaskFlagsTest::class, TaskNumbersTest::class, TaskDurationsTest::class, TaskLinksTest::class, TaskDurationsTest::class, TaskDatesTest::class, TaskStartsTest::class, TaskFinishesTest::class, TaskCostsTest::class, TaskTextTest::class, TaskOutlineCodesTest::class, TaskDeletionTest::class, TaskTextValuesTest::class, ProjectPropertiesTest::class, ProjectPropertiesOnlyTest::class, TaskBaselinesTest::class, TaskPercentCompleteTest::class, InvalidCalendarTest::class, DefaultDurationFormatTest::class, MppPasswordTest::class, ProjectValueListsTest::class, CalendarCalendarsTest::class, PrimaveraDatabaseReaderTest::class, TaskContainerTest::class, AvailabilityTableTest::class, AssignmentAssignmentsTest::class, AssignmentFlagsTest::class, AssignmentTextTest::class, ResourceMiscTest::class, ResourceFlagsTest::class, ResourceNumbersTest::class, ResourceTypeTest::class, ResourceTextTest::class, RecurringExceptionsTest::class, RecurringDataTest::class, CustomerDataTest::class)
class MpxjTestSuite// No class body required
