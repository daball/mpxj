...
class TimephasedTest {
   ...
   */
    ...
    fun testMpp9() {
        val file = MPPReader().read(MpxjTestData.filePath("mpp9timephased.mpp"))
        testTimephased(file)
    }
    ...
    @Throws(Exception::class)
    fun testMpp9From12() {
        val file = MPPReader().read(MpxjTestData.filePath("mpp9timephased-from12.mpp"))
        testTimephased(file)
    }
    ...
    @Throws(Exception::class)
    fun testMpp9From14() {
        val file = MPPReader().read(MpxjTestData.filePath("mpp9timephased-from14.mpp"))
        testTimephased(file)
    }
    ...
    @Throws(Exception::class)
    fun testMpp12() {
        val file = MPPReader().read(MpxjTestData.filePath("mpp12timephased.mpp"))
        testTimephased(file)
    }
    ...
    @Throws(Exception::class)
    fun testMpp12From14() {
        val file = MPPReader().read(MpxjTestData.filePath("mpp12timephased-from14.mpp"))
        testTimephased(file)
    }
    ...
    @Throws(Exception::class)
    fun testMpp14() {
        val file = MPPReader().read(MpxjTestData.filePath("mpp14timephased.mpp"))
        testTimephased(file)
    }
    ...
    @Throws(Exception::class)
    fun testMspdi() {
        val file = MSPDIReader().read(MpxjTestData.filePath("mspditimephased.xml"))
        testTimephased(file)
    }
     ...
     */
    private fun testTimephased(file: ProjectFile) {
        //
        // Basic assignment
        //
        ...
        var timephasedPlanned = assignment.timephasedWork
        assertEquals(3, timephasedPlanned!!.size())
        var timephased = timephasedPlanned!!.get(0)
        ...
        var timephasedComplete = assignment.timephasedActualWork
        ...
        timephasedPlanned = assignment.timephasedWork
        ...
        timephasedComplete = assignment.timephasedActualWork
        assertEquals(0, timephasedComplete!!.size())
        timephased = timephasedPlanned!!.get(0)
        testTimephased(timephased, "20/11/2008 09:00", "20/11/2008 17:00", 7.0, 7.0)
        timephased = timephasedPlanned!!.get(1)
        ...
        testTimephased(timephased, "09/12/2008 00:00", "10/12/2008 00:00", 1.5, -1.0) // 0.75 from MPP, 1.5 from MSPDI
     ...
     */
    private fun testTimephased(assignment: TimephasedWork, start: String, finish: String, totalWork: Double, workPerDay: Double) {
