...
object MpxjAssert {
     ...
     */
    fun assertBooleanEquals(message: String, expected: Boolean, actual: Boolean) {
     ...
     * @param actual actual value
     */
    fun assertBooleanEquals(expected: Boolean, actual: Boolean) {
     ...
     */
    fun assertDurationEquals(expectedDuration: Double, expectedUnits: TimeUnit, duration: Duration) {
        org.junit.Assert.assertEquals(expectedDuration, duration.duration, 0.005)
        org.junit.Assert.assertEquals(expectedUnits, duration.units)
    }
}
/**
