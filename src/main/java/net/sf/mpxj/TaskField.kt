 ...
 */
enum class TaskField// Must always be last value
...
private constructor(private val m_dataType: DataType,
    ...
    val fieldTypeClass: FieldTypeClass
        @Override get() = FieldTypeClass.TASK
    ...
    fun getName(locale: Locale): String? {
        val titles = LocaleData.getStringArray(locale, LocaleData.TASK_COLUMNS)
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): TaskField? {
        ...
        val MAX_VALUE = EnumSet.allOf(TaskField::class.java).size()
        private val TYPE_VALUES = arrayOfNulls<TaskField>(MAX_VALUE)

        init {
            var value = 0
            for (e in EnumSet.allOf(TaskField::class.java)) {
                e.m_value = value++
