 ...
 */
enum class AssignmentField// Must always be last value
...
private constructor(private val m_dataType: DataType,
    ...
    val fieldTypeClass: FieldTypeClass
        @Override get() = FieldTypeClass.ASSIGNMENT
    ...
    fun getName(locale: Locale): String? {
        val titles = LocaleData.getStringArray(locale, LocaleData.ASSIGNMENT_COLUMNS)
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): AssignmentField? {
        ...
        val MAX_VALUE = EnumSet.allOf(AssignmentField::class.java).size()
        private val TYPE_VALUES = arrayOfNulls<AssignmentField>(MAX_VALUE)

        init {
            var value = 0
            for (e in EnumSet.allOf(AssignmentField::class.java)) {
                e.m_value = value++
