...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): ProjectTimeFormat {
            var type = type
            if (type < 0 || type >= TYPE_VALUES.size) {
                type = TWELVE_HOUR.value
            }
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): ProjectTimeFormat {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(ProjectTimeFormat::class.java)
    }
}
