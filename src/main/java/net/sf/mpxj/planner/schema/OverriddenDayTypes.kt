...
class OverriddenDayTypes {

    @XmlElement(name = "overridden-day-type")
    protected var overriddenDayType: List<OverriddenDayType>? = null
     ...
     *
     */
    fun getOverriddenDayType(): List<OverriddenDayType> {
        if (overriddenDayType == null) {
            overriddenDayType = ArrayList<OverriddenDayType>()
        }
