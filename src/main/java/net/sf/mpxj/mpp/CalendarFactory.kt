 ...
 */
internal interface CalendarFactory {
    ...
    fun processCalendarData(projectDir: DirectoryEntry, projectProps: Props, inputStreamFactory: DocumentInputStreamFactory, resourceMap: HashMap<Integer, ProjectCalendar>)
}