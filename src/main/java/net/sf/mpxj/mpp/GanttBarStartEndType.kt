 ...
 */
enum class GanttBarStartEndType
/**
 * Private constructor.
 *
...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): GanttBarStartEndType {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): GanttBarStartEndType {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(GanttBarStartEndType::class.java)
    }
}
