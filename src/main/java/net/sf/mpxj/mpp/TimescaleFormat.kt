...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): TimescaleFormat {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): TimescaleFormat {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(TimescaleFormat::class.java, 3)
    }
}
