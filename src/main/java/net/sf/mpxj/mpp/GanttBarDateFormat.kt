...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): GanttBarDateFormat {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): GanttBarDateFormat {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(GanttBarDateFormat::class.java)
    }
}
