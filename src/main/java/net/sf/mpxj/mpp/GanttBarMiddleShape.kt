 ...
 */
enum class GanttBarMiddleShape
/**
 * Private constructor.
 *
...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): GanttBarMiddleShape {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): GanttBarMiddleShape {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(GanttBarMiddleShape::class.java)
    }
}
