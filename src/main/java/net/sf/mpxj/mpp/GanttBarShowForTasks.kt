 ...
 * method.
 */
enum class GanttBarShowForTasks
/**
 * Private constructor.
 *
...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): GanttBarShowForTasks {
            val result: GanttBarShowForTasks
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): GanttBarShowForTasks {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(GanttBarShowForTasks::class.java, 26)
