 ...
 */
enum class NonWorkingTimeStyle
/**
 * Private constructor.
 *
...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): NonWorkingTimeStyle {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): NonWorkingTimeStyle {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(NonWorkingTimeStyle::class.java)
    }
}
