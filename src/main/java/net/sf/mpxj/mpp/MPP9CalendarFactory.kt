 ...
 */
internal class MPP9CalendarFactory
/**
 * Constructor.
 *
...
(file: ProjectFile) : AbstractCalendarFactory(file) {
    ...
    override fun getCalendarVarMeta(directory: DirectoryEntry): VarMeta {
        return VarMeta9(DocumentInputStream(directory.getEntry("VarMeta") as DocumentEntry))
    }
    ...
    override fun processCalendarExceptions(data: ByteArray, cal: ProjectCalendar) {
        ...
        //
        val exceptionCount = MPPUtility.getShort(data, 0)
    ...
    companion object {
        ...
        private val CALENDAR_DATA = Integer.valueOf(3)
    }
}
