...
private constructor(private val m_value: String,
    ...
    companion object {
         ...
         */
        fun getInstance(value: String): CodePage {
            var result = NAME_MAP.get(value)
            if (result == null) {
                result = ANSI
            }
            return result
        ...
        private val NAME_MAP = HashMap<String, CodePage>()

        init {
            for (e in EnumSet.allOf(CodePage::class.java)) {
