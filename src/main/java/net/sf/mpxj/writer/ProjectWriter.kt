...
interface ProjectWriter {
    ...
    fun write(projectFile: ProjectFile, fileName: String)
     ...
     */
    @Throws(IOException::class)
    fun write(projectFile: ProjectFile, file: File)
     ...
     */
    @Throws(IOException::class)
    fun write(projectFile: ProjectFile, outputStream: OutputStream)
}
