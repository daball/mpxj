 ...
 */
abstract class AbstractProjectWriter : ProjectWriter {
    /**
     * {@inheritDoc}
     */
    @Override
    @Throws(IOException::class)
    override fun write(projectFile: ProjectFile, fileName: String) {
    ...
    @Override
    @Throws(IOException::class)
    override fun write(projectFile: ProjectFile, file: File) {
