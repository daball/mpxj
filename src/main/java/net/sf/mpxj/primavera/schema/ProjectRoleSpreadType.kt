...
@XmlType(name = "ProjectRoleSpreadType", propOrder = {
    "wbsObjectId",
...
class ProjectRoleSpreadType {
    ...
    protected var period: List<ProjectRoleSpreadType.Period>? = null
     ...
     *
     */
    fun getPeriod(): List<ProjectRoleSpreadType.Period> {
        if (period == null) {
            period = ArrayList<ProjectRoleSpreadType.Period>()
        }
        return this.period
    }
