...
/**
 *
 * Java class for ProjectCodeTypeType complex type.
 *
 *
...
@XmlType(name = "ProjectCodeTypeType", propOrder = {
    "createDate",
    "createUser",
    "isSecureCode",
    "lastUpdateDate",
...
class ProjectCodeTypeType {
     ...
     * [Double]
     */
    @XmlElement(name = "MaxCodeValueWeight", nillable = true)
    var maxCodeValueWeight: Double
    /**
