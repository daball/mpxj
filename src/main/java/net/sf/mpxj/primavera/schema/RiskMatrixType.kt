...
/**
 *
 * Java class for RiskMatrixType complex type.
 *
 *
...
@XmlType(name = "RiskMatrixType", propOrder = {
    "createDate",
    "createUser",
    "description",
...
class RiskMatrixType {
    ...
    var impactThresholdLevel: Integer
    /**
