...
/**
 *
 * Java class for EPSSpendingPlanType complex type.
 *
 *
...
@XmlType(name = "EPSSpendingPlanType", propOrder = {
    "benefitPlan",
    "createDate",
    "createUser",
    "date",
...
class EPSSpendingPlanType {
     ...
     * [Double]
     */
    @XmlElement(name = "BenefitPlan", nillable = true)
    var benefitPlan: Double
    /**
     ...
     * [Double]
     */
    @XmlElement(name = "SpendingPlan", nillable = true)
    var spendingPlan: Double
