...
/**
 *
 * Java class for EPSFundingType complex type.
 *
 *
...
@XmlType(name = "EPSFundingType", propOrder = {
    "amount",
    "createDate",
    "createUser",
    "epsId",
...
class EPSFundingType {
     ...
     * [Double]
     */
    @XmlElement(name = "FundShare", nillable = true)
    var fundShare: Double
    /**
    ...
    var fundingSourceObjectId: Integer
    /**
