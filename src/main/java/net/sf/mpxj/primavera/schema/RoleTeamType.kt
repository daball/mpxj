...
/**
 *
 * Java class for RoleTeamType complex type.
 *
 *
...
@XmlType(name = "RoleTeamType", propOrder = {
    "createDate",
    "createUser",
    "description",
    "lastUpdateDate",
...
class RoleTeamType {
    ...
    protected var memberRole: List<PortfolioTeamMemberType>? = null
     ...
     *
     */
    fun getMemberRole(): List<PortfolioTeamMemberType> {
        if (memberRole == null) {
            memberRole = ArrayList<PortfolioTeamMemberType>()
        }
