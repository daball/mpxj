...
(name: String, offset: Int) : AbstractShortColumn(name, offset) {
    ...
    override fun read(offset: Int, data: ByteArray): RelationType {
        val result = readShort(offset, data)
    ...
    companion object {
        ...
        private val TYPES = arrayOf<RelationType>(null, RelationType.START_START, RelationType.FINISH_START, RelationType.FINISH_FINISH)
    }
}
