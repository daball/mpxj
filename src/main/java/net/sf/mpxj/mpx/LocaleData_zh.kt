 ...
 */
class LocaleData_zh : ListResourceBundle() {
    /**
     * {@inheritDoc}
     */
    ...
    companion object {
        ...
        private val TIME_UNITS_ARRAY_DATA = arrayOf(arrayOf("m"), arrayOf("h"), arrayOf("d"), arrayOf("w"), arrayOf("mon"), arrayOf("y"), arrayOf("%"), arrayOf("em"), arrayOf("eh"), arrayOf("ed"), arrayOf("ew"), arrayOf("emon"), arrayOf("ey"), arrayOf("e%"))
        ...
        private val ACCRUE_TYPES_DATA = arrayOf("\u5F00\u59CB", // "Start",
                "\u7ED3\u675F", // "End",
                "\u6309\u6BD4\u4F8B" // "Prorated"
        )
        ...
        private val CONSTRAINT_TYPES_DATA = arrayOf("\u8D8A\u65E9\u8D8A\u597D", //   "As Soon As Possible",
        ...
        private val TASK_NAMES_DATA = arrayOf<String>(//
                ...
                "\u9879\u76EE", //   "Project",
                "\u552F\u4E00\u6807\u8BC6\u53F7", //   "Unique ID",
                "\u5927\u7EB2\u6570\u5B57", null, null, null, null, null, null, null, null, null, null, //
                "\u6807\u5FD71", //   "Flag1",
                "\u6807\u5FD72", //   "Flag2",
                "\u6807\u5FD73", //   "Flag3",
                "\u6807\u5FD74", //   "Flag4",
                ...
                "\u5B8C\u6210\u65F6\u95F44", //   "Finish4",
                "\u5F00\u59CB\u65F6\u95F45", //   "Start5",
                "\u5B8C\u6210\u65F6\u95F45", null, null, null, null, null, //
                "\u5DF2\u786E\u8BA4", //   "Confirmed",
                "\u9700\u8981\u66F4\u65B0", null, null, null, //
                "\u6570\u5B571", //   "Number1",
                "\u6570\u5B572", //   "Number2",
        ...
        private val RESOURCE_NAMES_DATA = arrayOf<String>(null, //
                ...
                "\u6587\u672C5", //   "Text5",
                "\u5907\u6CE8", //   "Notes",
                "\u7535\u5B50\u90AE\u4EF6\u5730\u5740", null, null, null, null, null, null, null, null, //
                "\u5DE5\u65F6", //   "Work",
                "\u6BD4\u8F83\u57FA\u51C6\u5DE5\u65F6", //   "Baseline Work",
                "\u5269\u4F59\u5DE5\u65F6", //   "Actual Work",
                "\u52A0\u73ED\u5DE5\u65F6", //   "Remaining Work",
                ...
                "\u5DE5\u65F6\u5DEE\u5F02", //   "Work Variance",
                "\u5DE5\u65F6\u5B8C\u6210\u767E\u5206\u6BD4", null, null, null, //
                "\u6210\u672C", //   "Cost",
                "\u6BD4\u8F83\u57FA\u51C6\u6210\u672C", //   "Baseline Cost",
                "\u5B9E\u9645\u6210\u672C", //   "Actual Cost",
                "\u5269\u4F59\u6210\u672C", //   "Remaining Cost",
                "\u6210\u672C\u5DEE\u5F02", null, null, null, null, null, //
                "\u6807\u8BC6\u53F7", //   "ID",
                "\u6700\u5927\u5355\u4F4D", //   "Max Units",
                "\u6807\u51C6\u8D39\u7387", //   "Standard Rate",
                "\u52A0\u73ED\u8D39\u7387", //   "Overtime Rate",
        ...
        private val RESOURCE_DATA = arrayOf<Array<Object>>(arrayOf<Object>(LocaleData.FILE_DELIMITER, ";"), arrayOf<Object>(LocaleData.PROGRAM_NAME, "Microsoft Project for Windows"), arrayOf<Object>(LocaleData.FILE_VERSION, "4.0"), arrayOf<Object>(LocaleData.CODE_PAGE, CodePage.ZH),
                ...
                arrayOf<Object>(LocaleData.YES, "\u662F"), arrayOf<Object>(LocaleData.NO, "\u5426"),
