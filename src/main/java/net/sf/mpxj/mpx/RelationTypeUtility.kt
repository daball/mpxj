 ...
 * for MPX files.
 */
internal object RelationTypeUtility {
     ...
     */
    fun getInstance(locale: Locale, type: String): RelationType? {
        var index = -1

        val relationTypes = LocaleData.getStringArray(locale, LocaleData.RELATION_TYPES)
        for (loop in relationTypes.indices) {
