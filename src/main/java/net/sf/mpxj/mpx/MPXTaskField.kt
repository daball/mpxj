 ...
 * task fields in MPXJ.
 */
internal object MPXTaskField {

    val MAX_FIELDS = 153

    private val MPX_MPXJ_ARRAY = arrayOfNulls<TaskField>(MAX_FIELDS)

    private val MPXJ_MPX_ARRAY = IntArray(TaskField.MAX_VALUE)
    /**
     ...
     */
    fun getMpxjField(value: Int): TaskField? {
        var result: TaskField? = null
