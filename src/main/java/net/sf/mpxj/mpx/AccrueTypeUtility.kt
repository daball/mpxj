 ...
 * for MPX files.
 */
internal object AccrueTypeUtility {
     ...
     */
    fun getInstance(type: String, locale: Locale): AccrueType? {
        var result: AccrueType? = null

        val typeNames = LocaleData.getStringArray(locale, LocaleData.ACCRUE_TYPES)

        for (loop in typeNames.indices) {
