 ...
 * for MPX files.
 */
internal object ConstraintTypeUtility {
     ...
     */
    fun getInstance(locale: Locale, type: String): ConstraintType {
        var index = 0

        val constraintTypes = LocaleData.getStringArray(locale, LocaleData.CONSTRAINT_TYPES)
        for (loop in constraintTypes.indices) {
