...
(
     ...
     */
    val values: List<ActivityCodeValue> = ArrayList<ActivityCodeValue>()
     ...
     */
    fun addValue(uniqueID: Integer, name: String, description: String): ActivityCodeValue {
        val value = ActivityCodeValue(this, uniqueID, name, description)
        values.add(value)
        return value
    }
}
