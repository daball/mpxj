...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): ResourceType {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): ResourceType {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(ResourceType::class.java)
    }
}
