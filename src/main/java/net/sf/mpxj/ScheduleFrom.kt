...
private constructor(
    ...
    companion object {
         ...
         */
        fun getInstance(type: Int): ScheduleFrom {
            var type = type
         ...
         * @return enum instance
         */
        fun getInstance(type: Number?): ScheduleFrom {
            val value: Int
            if (type == null) {
                value = -1
            } else {
         ...
         */
        private val TYPE_VALUES = EnumHelper.createTypeArray(ScheduleFrom::class.java)
    }
}
