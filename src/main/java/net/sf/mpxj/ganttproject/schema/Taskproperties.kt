...
/**
 *
 * Java class for taskproperties complex type.
 *
 *
...
class Taskproperties {
    ...
    protected var taskproperty: List<Taskproperty>? = null
     ...
     *
     */
    fun getTaskproperty(): List<Taskproperty> {
        if (taskproperty == null) {
            taskproperty = ArrayList<Taskproperty>()
        }
