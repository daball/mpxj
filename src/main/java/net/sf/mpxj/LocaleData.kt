...
class LocaleData : ListResourceBundle() {
    ...
    companion object {
        ...
        val TASK_COLUMNS = "TASK_COLUMNS"
        val RESOURCE_COLUMNS = "RESOURCE_COLUMNS"
        val ASSIGNMENT_COLUMNS = "ASSIGNMENT_COLUMNS"
        val CONSTRAINT_COLUMNS = "CONSTRAINT_COLUMNS"
        val PROJECT_COLUMNS = "PROJECT_COLUMNS"

        private val RESOURCE_COLUMNS_ARRAY = arrayOfNulls<String>(ResourceField.MAX_VALUE)
        private val TASK_COLUMNS_ARRAY = arrayOfNulls<String>(TaskField.MAX_VALUE)
        private val ASSIGNMENT_COLUMNS_ARRAY = arrayOfNulls<String>(AssignmentField.MAX_VALUE)
        private val CONSTRAINT_COLUMNS_ARRAY = arrayOfNulls<String>(ConstraintField.MAX_VALUE)
        private val PROJECT_COLUMNS_ARRAY = arrayOfNulls<String>(ProjectField.MAX_VALUE)
        ...
        init {
            ...
            RESOURCE_COLUMNS_ARRAY[ResourceField.ID.value] = "ID"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NAME.value] = "Name"
            RESOURCE_COLUMNS_ARRAY[ResourceField.INITIALS.value] = "Initials"
            RESOURCE_COLUMNS_ARRAY[ResourceField.GROUP.value] = "Group"
            RESOURCE_COLUMNS_ARRAY[ResourceField.MAX_UNITS.value] = "Max Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASE_CALENDAR.value] = "Base Calendar"
            RESOURCE_COLUMNS_ARRAY[ResourceField.STANDARD_RATE.value] = "Standard Rate"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OVERTIME_RATE.value] = "Overtime Rate"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT1.value] = "Text1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT2.value] = "Text2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.CODE.value] = "Code"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_COST.value] = "Actual Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST.value] = "Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.WORK.value] = "Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_WORK.value] = "Actual Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE_WORK.value] = "Baseline Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OVERTIME_WORK.value] = "Overtime Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE_COST.value] = "Baseline Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_PER_USE.value] = "Cost Per Use"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACCRUE_AT.value] = "Accrue At"
            RESOURCE_COLUMNS_ARRAY[ResourceField.REMAINING_COST.value] = "Remaining Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.REMAINING_WORK.value] = "Remaining Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.WORK_VARIANCE.value] = "Work Variance"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_VARIANCE.value] = "Cost Variance"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OVERALLOCATED.value] = "Overallocated"
            RESOURCE_COLUMNS_ARRAY[ResourceField.PEAK.value] = "Peak"
            RESOURCE_COLUMNS_ARRAY[ResourceField.UNIQUE_ID.value] = "Unique ID"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NOTES.value] = "Notes"
            RESOURCE_COLUMNS_ARRAY[ResourceField.PERCENT_WORK_COMPLETE.value] = "% Work Complete"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT3.value] = "Text3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT4.value] = "Text4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT5.value] = "Text5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OBJECTS.value] = "Objects"
            RESOURCE_COLUMNS_ARRAY[ResourceField.LINKED_FIELDS.value] = "Linked Fields"
            RESOURCE_COLUMNS_ARRAY[ResourceField.EMAIL_ADDRESS.value] = "Email Address"
            RESOURCE_COLUMNS_ARRAY[ResourceField.REGULAR_WORK.value] = "Regular Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_OVERTIME_WORK.value] = "Actual Overtime Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.REMAINING_OVERTIME_WORK.value] = "Remaining Overtime Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OVERTIME_COST.value] = "Overtime Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_OVERTIME_COST.value] = "Actual Overtime Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.REMAINING_OVERTIME_COST.value] = "Remaining Overtime Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BCWS.value] = "BCWS"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BCWP.value] = "BCWP"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACWP.value] = "ACWP"
            RESOURCE_COLUMNS_ARRAY[ResourceField.SV.value] = "SV"
            RESOURCE_COLUMNS_ARRAY[ResourceField.AVAILABLE_FROM.value] = "Available From"
            RESOURCE_COLUMNS_ARRAY[ResourceField.AVAILABLE_TO.value] = "Available To"
            RESOURCE_COLUMNS_ARRAY[ResourceField.INDICATORS.value] = "Indicators"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT6.value] = "Text6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT7.value] = "Text7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT8.value] = "Text8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT9.value] = "Text9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT10.value] = "Text10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START1.value] = "Start1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START2.value] = "Start2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START3.value] = "Start3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START4.value] = "Start4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START5.value] = "Start5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH1.value] = "Finish1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH2.value] = "Finish2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH3.value] = "Finish3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH4.value] = "Finish4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH5.value] = "Finish5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER1.value] = "Number1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER2.value] = "Number2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER3.value] = "Number3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER4.value] = "Number4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER5.value] = "Number5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION1.value] = "Duration1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION2.value] = "Duration2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION3.value] = "Duration3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST1.value] = "Cost1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST2.value] = "Cost2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST3.value] = "Cost3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG10.value] = "Flag10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG1.value] = "Flag1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG2.value] = "Flag2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG3.value] = "Flag3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG4.value] = "Flag4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG5.value] = "Flag5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG6.value] = "Flag6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG7.value] = "Flag7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG8.value] = "Flag8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG9.value] = "Flag9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.HYPERLINK.value] = "Hyperlink"
            RESOURCE_COLUMNS_ARRAY[ResourceField.HYPERLINK_ADDRESS.value] = "Hyperlink Address"
            RESOURCE_COLUMNS_ARRAY[ResourceField.HYPERLINK_SUBADDRESS.value] = "Hyperlink SubAddress"
            RESOURCE_COLUMNS_ARRAY[ResourceField.HYPERLINK_HREF.value] = "Hyperlink Href"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ASSIGNMENT.value] = "Assignment"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TASK_SUMMARY_NAME.value] = "Task Summary Name"
            RESOURCE_COLUMNS_ARRAY[ResourceField.CAN_LEVEL.value] = "Can Level"
            RESOURCE_COLUMNS_ARRAY[ResourceField.WORK_CONTOUR.value] = "Work Contour"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST4.value] = "Cost4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST5.value] = "Cost5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST6.value] = "Cost6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST7.value] = "Cost7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST8.value] = "Cost8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST9.value] = "Cost9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST10.value] = "Cost10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE1.value] = "Date1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE2.value] = "Date2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE3.value] = "Date3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE4.value] = "Date4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE5.value] = "Date5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE6.value] = "Date6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE7.value] = "Date7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE8.value] = "Date8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE9.value] = "Date9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DATE10.value] = "Date10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION4.value] = "Duration4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION5.value] = "Duration5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION6.value] = "Duration6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION7.value] = "Duration7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION8.value] = "Duration8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION9.value] = "Duration9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION10.value] = "Duration10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH6.value] = "Finish6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH7.value] = "Finish7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH8.value] = "Finish8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH9.value] = "Finish9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH10.value] = "Finish10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG11.value] = "Flag11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG12.value] = "Flag12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG13.value] = "Flag13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG14.value] = "Flag14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG15.value] = "Flag15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG16.value] = "Flag16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG17.value] = "Flag17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG18.value] = "Flag18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG19.value] = "Flag19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FLAG20.value] = "Flag20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER6.value] = "Number6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER7.value] = "Number7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER8.value] = "Number8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER9.value] = "Number9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER10.value] = "Number10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER11.value] = "Number11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER12.value] = "Number12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER13.value] = "Number13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER14.value] = "Number14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER15.value] = "Number15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER16.value] = "Number16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER17.value] = "Number17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER18.value] = "Number18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER19.value] = "Number19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.NUMBER20.value] = "Number20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START6.value] = "Start6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START7.value] = "Start7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START8.value] = "Start8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START9.value] = "Start9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START10.value] = "Start10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT11.value] = "Text11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT12.value] = "Text12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT13.value] = "Text13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT14.value] = "Text14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT15.value] = "Text15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT16.value] = "Text16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT17.value] = "Text17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT18.value] = "Text18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT19.value] = "Text19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT20.value] = "Text20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT21.value] = "Text21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT22.value] = "Text22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT23.value] = "Text23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT24.value] = "Text24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT25.value] = "Text25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT26.value] = "Text26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT27.value] = "Text27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT28.value] = "Text28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT29.value] = "Text29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEXT30.value] = "Text30"
            RESOURCE_COLUMNS_ARRAY[ResourceField.PHONETICS.value] = "Phonetics"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ASSIGNMENT_DELAY.value] = "Assignment Delay"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ASSIGNMENT_UNITS.value] = "Assignment Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE_START.value] = "Baseline Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE_FINISH.value] = "Baseline Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.CONFIRMED.value] = "Confirmed"
            RESOURCE_COLUMNS_ARRAY[ResourceField.FINISH.value] = "Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.LEVELING_DELAY.value] = "Leveling Delay"
            RESOURCE_COLUMNS_ARRAY[ResourceField.RESPONSE_PENDING.value] = "Response Pending"
            RESOURCE_COLUMNS_ARRAY[ResourceField.START.value] = "Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEAMSTATUS_PENDING.value] = "TeamStatus Pending"
            RESOURCE_COLUMNS_ARRAY[ResourceField.CV.value] = "CV"
            RESOURCE_COLUMNS_ARRAY[ResourceField.UPDATE_NEEDED.value] = "Update Needed"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_RATE_TABLE.value] = "Cost Rate Table"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_START.value] = "Actual Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_FINISH.value] = "Actual Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.WORKGROUP.value] = "Workgroup"
            RESOURCE_COLUMNS_ARRAY[ResourceField.PROJECT.value] = "Project"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE1.value] = "Outline Code1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE2.value] = "Outline Code2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE3.value] = "Outline Code3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE4.value] = "Outline Code4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE5.value] = "Outline Code5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE6.value] = "Outline Code6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE7.value] = "Outline Code7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE8.value] = "Outline Code8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE9.value] = "Outline Code9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE10.value] = "Outline Code10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.MATERIAL_LABEL.value] = "Material Label"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TYPE.value] = "Type"
            RESOURCE_COLUMNS_ARRAY[ResourceField.VAC.value] = "VAC"
            RESOURCE_COLUMNS_ARRAY[ResourceField.GROUP_BY_SUMMARY.value] = "Group By Summary"
            RESOURCE_COLUMNS_ARRAY[ResourceField.WINDOWS_USER_ACCOUNT.value] = "Windows User Account"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE1_WORK.value] = "Baseline1 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE1_COST.value] = "Baseline1 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE2_WORK.value] = "Baseline2 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE2_COST.value] = "Baseline2 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE3_WORK.value] = "Baseline3 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE3_COST.value] = "Baseline3 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE4_WORK.value] = "Baseline4 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE4_COST.value] = "Baseline4 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE5_WORK.value] = "Baseline5 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE5_COST.value] = "Baseline5 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE6_WORK.value] = "Baseline6 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE6_COST.value] = "Baseline6 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE7_WORK.value] = "Baseline7 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE7_COST.value] = "Baseline7 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE8_WORK.value] = "Baseline8 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE8_COST.value] = "Baseline8 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE9_WORK.value] = "Baseline9 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE9_COST.value] = "Baseline9 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE10_WORK.value] = "Baseline10 Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE10_COST.value] = "Baseline10 Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST1.value] = "Enterprise Cost1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST2.value] = "Enterprise Cost2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST3.value] = "Enterprise Cost3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST4.value] = "Enterprise Cost4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST5.value] = "Enterprise Cost5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST6.value] = "Enterprise Cost6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST7.value] = "Enterprise Cost7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST8.value] = "Enterprise Cost8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST9.value] = "Enterprise Cost9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_COST10.value] = "Enterprise Cost10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE1.value] = "Enterprise Date1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE2.value] = "Enterprise Date2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE3.value] = "Enterprise Date3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE4.value] = "Enterprise Date4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE5.value] = "Enterprise Date5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE6.value] = "Enterprise Date6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE7.value] = "Enterprise Date7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE8.value] = "Enterprise Date8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE9.value] = "Enterprise Date9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE10.value] = "Enterprise Date10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE11.value] = "Enterprise Date11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE12.value] = "Enterprise Date12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE13.value] = "Enterprise Date13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE14.value] = "Enterprise Date14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE15.value] = "Enterprise Date15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE16.value] = "Enterprise Date16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE17.value] = "Enterprise Date17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE18.value] = "Enterprise Date18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE19.value] = "Enterprise Date19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE20.value] = "Enterprise Date20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE21.value] = "Enterprise Date21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE22.value] = "Enterprise Date22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE23.value] = "Enterprise Date23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE24.value] = "Enterprise Date24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE25.value] = "Enterprise Date25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE26.value] = "Enterprise Date26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE27.value] = "Enterprise Date27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE28.value] = "Enterprise Date28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE29.value] = "Enterprise Date29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATE30.value] = "Enterprise Date30"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION1.value] = "Enterprise Duration1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION2.value] = "Enterprise Duration2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION3.value] = "Enterprise Duration3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION4.value] = "Enterprise Duration4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION5.value] = "Enterprise Duration5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION6.value] = "Enterprise Duration6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION7.value] = "Enterprise Duration7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION8.value] = "Enterprise Duration8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION9.value] = "Enterprise Duration9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION10.value] = "Enterprise Duration10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG1.value] = "Enterprise Flag1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG2.value] = "Enterprise Flag2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG3.value] = "Enterprise Flag3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG4.value] = "Enterprise Flag4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG5.value] = "Enterprise Flag5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG6.value] = "Enterprise Flag6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG7.value] = "Enterprise Flag7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG8.value] = "Enterprise Flag8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG9.value] = "Enterprise Flag9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG10.value] = "Enterprise Flag10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG11.value] = "Enterprise Flag11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG12.value] = "Enterprise Flag12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG13.value] = "Enterprise Flag13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG14.value] = "Enterprise Flag14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG15.value] = "Enterprise Flag15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG16.value] = "Enterprise Flag16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG17.value] = "Enterprise Flag17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG18.value] = "Enterprise Flag18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG19.value] = "Enterprise Flag19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_FLAG20.value] = "Enterprise Flag20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER1.value] = "Enterprise Number1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER2.value] = "Enterprise Number2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER3.value] = "Enterprise Number3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER4.value] = "Enterprise Number4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER5.value] = "Enterprise Number5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER6.value] = "Enterprise Number6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER7.value] = "Enterprise Number7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER8.value] = "Enterprise Number8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER9.value] = "Enterprise Number9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER10.value] = "Enterprise Number10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER11.value] = "Enterprise Number11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER12.value] = "Enterprise Number12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER13.value] = "Enterprise Number13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER14.value] = "Enterprise Number14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER15.value] = "Enterprise Number15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER16.value] = "Enterprise Number16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER17.value] = "Enterprise Number17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER18.value] = "Enterprise Number18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER19.value] = "Enterprise Number19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER20.value] = "Enterprise Number20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER21.value] = "Enterprise Number21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER22.value] = "Enterprise Number22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER23.value] = "Enterprise Number23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER24.value] = "Enterprise Number24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER25.value] = "Enterprise Number25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER26.value] = "Enterprise Number26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER27.value] = "Enterprise Number27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER28.value] = "Enterprise Number28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER29.value] = "Enterprise Number29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER30.value] = "Enterprise Number30"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER31.value] = "Enterprise Number31"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER32.value] = "Enterprise Number32"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER33.value] = "Enterprise Number33"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER34.value] = "Enterprise Number34"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER35.value] = "Enterprise Number35"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER36.value] = "Enterprise Number36"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER37.value] = "Enterprise Number37"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER38.value] = "Enterprise Number38"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER39.value] = "Enterprise Number39"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NUMBER40.value] = "Enterprise Number40"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT1.value] = "Enterprise Text1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT2.value] = "Enterprise Text2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT3.value] = "Enterprise Text3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT4.value] = "Enterprise Text4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT5.value] = "Enterprise Text5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT6.value] = "Enterprise Text6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT7.value] = "Enterprise Text7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT8.value] = "Enterprise Text8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT9.value] = "Enterprise Text9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT10.value] = "Enterprise Text10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT11.value] = "Enterprise Text11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT12.value] = "Enterprise Text12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT13.value] = "Enterprise Text13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT14.value] = "Enterprise Text14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT15.value] = "Enterprise Text15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT16.value] = "Enterprise Text16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT17.value] = "Enterprise Text17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT18.value] = "Enterprise Text18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT19.value] = "Enterprise Text19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT20.value] = "Enterprise Text20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT21.value] = "Enterprise Text21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT22.value] = "Enterprise Text22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT23.value] = "Enterprise Text23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT24.value] = "Enterprise Text24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT25.value] = "Enterprise Text25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT26.value] = "Enterprise Text26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT27.value] = "Enterprise Text27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT28.value] = "Enterprise Text28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT29.value] = "Enterprise Text29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT30.value] = "Enterprise Text30"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT31.value] = "Enterprise Text31"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT32.value] = "Enterprise Text32"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT33.value] = "Enterprise Text33"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT34.value] = "Enterprise Text34"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT35.value] = "Enterprise Text35"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT36.value] = "Enterprise Text36"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT37.value] = "Enterprise Text37"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT38.value] = "Enterprise Text38"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT39.value] = "Enterprise Text39"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEXT40.value] = "Enterprise Text40"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE.value] = "Enterprise"
            RESOURCE_COLUMNS_ARRAY[ResourceField.IMPORT.value] = "Import"
            RESOURCE_COLUMNS_ARRAY[ResourceField.CREATED.value] = "Created"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BUDGET.value] = "Budget"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TASK_OUTLINE_NUMBER.value] = "Task Outline Number"
            RESOURCE_COLUMNS_ARRAY[ResourceField.GUID.value] = "GUID"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTIVE.value] = "Active"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ASSIGNMENT_OWNER.value] = "Assignment Owner"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE_BUDGET_COST.value] = "Baseline Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE_BUDGET_WORK.value] = "Baseline Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE1_BUDGET_COST.value] = "Baseline1 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE1_BUDGET_WORK.value] = "Baseline1 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE1_FINISH.value] = "Baseline1 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE1_START.value] = "Baseline1 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE2_BUDGET_COST.value] = "Baseline2 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE2_BUDGET_WORK.value] = "Baseline2 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE2_FINISH.value] = "Baseline2 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE2_START.value] = "Baseline2 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE3_BUDGET_COST.value] = "Baseline3 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE3_BUDGET_WORK.value] = "Baseline3 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE3_FINISH.value] = "Baseline3 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE3_START.value] = "Baseline3 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE4_BUDGET_COST.value] = "Baseline4 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE4_BUDGET_WORK.value] = "Baseline4 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE4_FINISH.value] = "Baseline4 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE4_START.value] = "Baseline4 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE5_BUDGET_COST.value] = "Baseline5 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE5_BUDGET_WORK.value] = "Baseline5 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE5_FINISH.value] = "Baseline5 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE5_START.value] = "Baseline5 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE6_BUDGET_COST.value] = "Baseline6 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE6_BUDGET_WORK.value] = "Baseline6 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE6_FINISH.value] = "Baseline6 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE6_START.value] = "Baseline6 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE7_BUDGET_COST.value] = "Baseline7 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE7_BUDGET_WORK.value] = "Baseline7 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE7_FINISH.value] = "Baseline7 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE7_START.value] = "Baseline7 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE8_BUDGET_COST.value] = "Baseline8 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE8_BUDGET_WORK.value] = "Baseline8 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE8_FINISH.value] = "Baseline8 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE8_START.value] = "Baseline8 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE9_BUDGET_COST.value] = "Baseline9 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE9_BUDGET_WORK.value] = "Baseline9 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE9_FINISH.value] = "Baseline9 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE9_START.value] = "Baseline9 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE10_BUDGET_COST.value] = "Baseline10 Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE10_BUDGET_WORK.value] = "Baseline10 Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE10_FINISH.value] = "Baseline10 Finish"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BASELINE10_START.value] = "Baseline10 Start"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BOOKING_TYPE.value] = "Booking Type"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BUDGET_COST.value] = "Budget Cost"
            RESOURCE_COLUMNS_ARRAY[ResourceField.BUDGET_WORK.value] = "Budget Work"
            RESOURCE_COLUMNS_ARRAY[ResourceField.CALENDAR_GUID.value] = "Calendar GUID"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_CENTER.value] = "Cost Center"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DEFAULT_ASSIGNMENT_OWNER.value] = "Default Assignment Owner"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_BASE_CALENDAR.value] = "Enterprise Base Calendar"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_REQUIRED_VALUES.value] = "Enterprise Required Values"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_TEAM_MEMBER.value] = "Enterprise Team Member"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_UNIQUE_ID.value] = "Enterprise Unique ID"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ERROR_MESSAGE.value] = "Error Message"
            RESOURCE_COLUMNS_ARRAY[ResourceField.GENERIC.value] = "Generic"
            RESOURCE_COLUMNS_ARRAY[ResourceField.INACTIVE.value] = "Inactive"
            RESOURCE_COLUMNS_ARRAY[ResourceField.REQUEST_DEMAND.value] = "Request/Demand"
            RESOURCE_COLUMNS_ARRAY[ResourceField.SUMMARY.value] = "Summary"
            RESOURCE_COLUMNS_ARRAY[ResourceField.TEAM_ASSIGNMENT_POOL.value] = "Team Assignment Pool"
            RESOURCE_COLUMNS_ARRAY[ResourceField.WBS.value] = "WBS"
            RESOURCE_COLUMNS_ARRAY[ResourceField.UNAVAILABLE.value] = "<Unavailable>"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION1_UNITS.value] = "Duration1 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION2_UNITS.value] = "Duration2 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION3_UNITS.value] = "Duration3 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION4_UNITS.value] = "Duration4 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION5_UNITS.value] = "Duration5 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION6_UNITS.value] = "Duration6 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION7_UNITS.value] = "Duration7 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION8_UNITS.value] = "Duration8 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION9_UNITS.value] = "Duration9 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.DURATION10_UNITS.value] = "Duration10 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.SUBPROJECT_RESOURCE_UNIQUE_ID.value] = "Subproject Unique Resource ID"
            RESOURCE_COLUMNS_ARRAY[ResourceField.HYPERLINK_DATA.value] = "Hyperlink Data"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE1_INDEX.value] = "Outline Code1 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE2_INDEX.value] = "Outline Code2 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE3_INDEX.value] = "Outline Code3 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE4_INDEX.value] = "Outline Code4 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE5_INDEX.value] = "Outline Code5 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE6_INDEX.value] = "Outline Code6 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE7_INDEX.value] = "Outline Code7 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE8_INDEX.value] = "Outline Code8 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE9_INDEX.value] = "Outline Code9 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OUTLINE_CODE10_INDEX.value] = "Outline Code10 Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_RATE_A.value] = "Cost Rate A"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_RATE_B.value] = "Cost Rate B"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_RATE_C.value] = "Cost Rate C"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_RATE_D.value] = "Cost Rate D"
            RESOURCE_COLUMNS_ARRAY[ResourceField.COST_RATE_E.value] = "Cost Rate E"
            RESOURCE_COLUMNS_ARRAY[ResourceField.AVAILABILITY_DATA.value] = "Availability Data"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DATA.value] = "Enterprise Data"
            RESOURCE_COLUMNS_ARRAY[ResourceField.STANDARD_RATE_UNITS.value] = "Standard Rate Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.OVERTIME_RATE_UNITS.value] = "Overtime Rate Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION1_UNITS.value] = "Enterprise Duration1 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION2_UNITS.value] = "Enterprise Duration2 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION3_UNITS.value] = "Enterprise Duration3 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION4_UNITS.value] = "Enterprise Duration4 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION5_UNITS.value] = "Enterprise Duration5 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION6_UNITS.value] = "Enterprise Duration6 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION7_UNITS.value] = "Enterprise Duration7 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION8_UNITS.value] = "Enterprise Duration8 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION9_UNITS.value] = "Enterprise Duration9 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_DURATION10_UNITS.value] = "Enterprise Duration10 Units"
            RESOURCE_COLUMNS_ARRAY[ResourceField.INDEX.value] = "Index"
            RESOURCE_COLUMNS_ARRAY[ResourceField.HYPERLINK_SCREEN_TIP.value] = "Hyperlink Screen Tip"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE1.value] = "Enterprise Outline Code1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE2.value] = "Enterprise Outline Code2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE3.value] = "Enterprise Outline Code3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE4.value] = "Enterprise Outline Code4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE5.value] = "Enterprise Outline Code5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE6.value] = "Enterprise Outline Code6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE7.value] = "Enterprise Outline Code7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE8.value] = "Enterprise Outline Code8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE9.value] = "Enterprise Outline Code9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE10.value] = "Enterprise Outline Code10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE11.value] = "Enterprise Outline Code11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE12.value] = "Enterprise Outline Code12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE13.value] = "Enterprise Outline Code13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE14.value] = "Enterprise Outline Code14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE15.value] = "Enterprise Outline Code15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE16.value] = "Enterprise Outline Code16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE17.value] = "Enterprise Outline Code17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE18.value] = "Enterprise Outline Code18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE19.value] = "Enterprise Outline Code19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE20.value] = "Enterprise Outline Code20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE21.value] = "Enterprise Outline Code21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE22.value] = "Enterprise Outline Code22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE23.value] = "Enterprise Outline Code23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE24.value] = "Enterprise Outline Code24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE25.value] = "Enterprise Outline Code25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE26.value] = "Enterprise Outline Code26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE27.value] = "Enterprise Outline Code27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE28.value] = "Enterprise Outline Code28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_OUTLINE_CODE29.value] = "Enterprise Outline Code29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_RBS.value] = "Enterprise RBS"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_NAME_USED.value] = "Enterprise Name Used"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_IS_CHECKED_OUT.value] = "Enterprise Is Checked Out"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CHECKED_OUT_BY.value] = "Enterprise Checked Out By"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_LAST_MODIFIED_DATE.value] = "Enterprise Last Modified Date"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE20.value] = "Enterprise Multi Value20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE21.value] = "Enterprise Multi Value21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE22.value] = "Enterprise Multi Value22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE23.value] = "Enterprise Multi Value23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE24.value] = "Enterprise Multi Value24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE25.value] = "Enterprise Multi Value25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE26.value] = "Enterprise Multi Value26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE27.value] = "Enterprise Multi Value27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE28.value] = "Enterprise Multi Value28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_MULTI_VALUE29.value] = "Enterprise Multi Value29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_WORK_PROTECTED.value] = "Actual Work Protected"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ACTUAL_OVERTIME_WORK_PROTECTED.value] = "Actual Overtime Work Protected"

            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD1.value] = "Enterprise Custom Field 1"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD2.value] = "Enterprise Custom Field 2"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD3.value] = "Enterprise Custom Field 3"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD4.value] = "Enterprise Custom Field 4"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD5.value] = "Enterprise Custom Field 5"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD6.value] = "Enterprise Custom Field 6"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD7.value] = "Enterprise Custom Field 7"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD8.value] = "Enterprise Custom Field 8"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD9.value] = "Enterprise Custom Field 9"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD10.value] = "Enterprise Custom Field 10"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD11.value] = "Enterprise Custom Field 11"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD12.value] = "Enterprise Custom Field 12"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD13.value] = "Enterprise Custom Field 13"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD14.value] = "Enterprise Custom Field 14"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD15.value] = "Enterprise Custom Field 15"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD16.value] = "Enterprise Custom Field 16"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD17.value] = "Enterprise Custom Field 17"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD18.value] = "Enterprise Custom Field 18"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD19.value] = "Enterprise Custom Field 19"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD20.value] = "Enterprise Custom Field 20"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD21.value] = "Enterprise Custom Field 21"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD22.value] = "Enterprise Custom Field 22"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD23.value] = "Enterprise Custom Field 23"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD24.value] = "Enterprise Custom Field 24"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD25.value] = "Enterprise Custom Field 25"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD26.value] = "Enterprise Custom Field 26"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD27.value] = "Enterprise Custom Field 27"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD28.value] = "Enterprise Custom Field 28"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD29.value] = "Enterprise Custom Field 29"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD30.value] = "Enterprise Custom Field 30"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD31.value] = "Enterprise Custom Field 31"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD32.value] = "Enterprise Custom Field 32"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD33.value] = "Enterprise Custom Field 33"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD34.value] = "Enterprise Custom Field 34"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD35.value] = "Enterprise Custom Field 35"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD36.value] = "Enterprise Custom Field 36"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD37.value] = "Enterprise Custom Field 37"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD38.value] = "Enterprise Custom Field 38"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD39.value] = "Enterprise Custom Field 39"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD40.value] = "Enterprise Custom Field 40"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD41.value] = "Enterprise Custom Field 41"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD42.value] = "Enterprise Custom Field 42"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD43.value] = "Enterprise Custom Field 43"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD44.value] = "Enterprise Custom Field 44"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD45.value] = "Enterprise Custom Field 45"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD46.value] = "Enterprise Custom Field 46"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD47.value] = "Enterprise Custom Field 47"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD48.value] = "Enterprise Custom Field 48"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD49.value] = "Enterprise Custom Field 49"
            RESOURCE_COLUMNS_ARRAY[ResourceField.ENTERPRISE_CUSTOM_FIELD50.value] = "Enterprise Custom Field 50"
        ...
        private val RESOURCES = arrayOf<Array<Object>>(arrayOf<Object>("TASK_COLUMNS", TASK_COLUMNS_ARRAY), arrayOf<Object>("RESOURCE_COLUMNS", RESOURCE_COLUMNS_ARRAY), arrayOf<Object>("ASSIGNMENT_COLUMNS", ASSIGNMENT_COLUMNS_ARRAY), arrayOf<Object>("CONSTRAINT_COLUMNS", CONSTRAINT_COLUMNS_ARRAY), arrayOf<Object>("PROJECT_COLUMNS", PROJECT_COLUMNS_ARRAY))
    }
}
