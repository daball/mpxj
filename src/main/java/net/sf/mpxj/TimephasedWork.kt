 ...
 */
class TimephasedWork : TimephasedItem<Duration> {
    /**
     * Default constructor.
     */
    constructor() : super() {}
     ...
     */
    constructor(sourceItem: TimephasedWork) {
     ...
     */
    constructor(sourceItem: TimephasedWork, totalFactor: Double, perDayFactor: Double) {
        setStart(sourceItem.getStart())
        setFinish(sourceItem.getFinish())
        setModified(sourceItem.getModified())
