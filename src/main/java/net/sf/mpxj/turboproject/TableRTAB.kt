 ...
 */
internal class TableRTAB : Table() {
    ...
    override fun readRow(uniqueID: Int, data: ByteArray) {
        if (data[0] != 0xFF.toByte()) {
            ...
            map.put("EXPENSES_ONLY", Boolean.valueOf(data[106] and 0x01 != 0))
            map.put("MODIFY_ON_INTEGRATE", Boolean.valueOf(data[106] and 0x02 != 0))
