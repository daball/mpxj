 ...
 */
internal class TableCONTAB : Table() {
    /**
     * {@inheritDoc}
     */
    @Override
     ...
     */
    private fun getRelationType(value: Int): RelationType {
        var result: RelationType? = null
        if (value >= 0 || value < RELATION_TYPES.size) {
    ...
    companion object {
        ...
        private val RELATION_TYPES = arrayOf<RelationType>(null, RelationType.START_START, null, RelationType.FINISH_START, RelationType.FINISH_FINISH)
    }
}
