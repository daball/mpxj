 ...
 */
(`object`: Object, excludedMethods: Set<String>) : JPanel() {
    private val m_objectPropertiesModel: ObjectPropertiesModel
    private val m_objectPropertiesController: ObjectPropertiesController
    private val m_objectPropertiesView: ObjectPropertiesView

    init {
        setLayout(GridLayout(0, 1, 0, 0))

        m_objectPropertiesModel = ObjectPropertiesModel()
        m_objectPropertiesController = ObjectPropertiesController(m_objectPropertiesModel)
        m_objectPropertiesView = ObjectPropertiesView(m_objectPropertiesModel)
