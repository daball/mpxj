 ...
 */
@JvmOverloads constructor(`object`: Object? = null,
                          /**
                           * Retrieve the set of excluded method names.
                           *
                           * @return set of excluded method names
                           */
                          val excludedMethods: Set<String> = DEFAULT_EXCLUDED_METHODS) : DefaultMutableTreeNode(`object`) {
    companion object {

        val DEFAULT_EXCLUDED_METHODS: Set<String> = HashSet<String>(Arrays.asList("getClass", "getParentFile", "getInstance"))
    }
