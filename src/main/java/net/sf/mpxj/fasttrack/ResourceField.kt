 ...
 */
internal enum class ResourceField
/**
 * Constructor.
 *
...
private constructor(private val m_value: Int) : FastTrackField {
    ...
    companion object {
        ...
        private val MAP = arrayOfNulls<ResourceField>(IMAGE_10.m_value + 1)

        init {
            for (field in ResourceField.values()) {
