 ...
 */
internal enum class ActivityField
/**
 * Constructor.
 *
 * @param value field ID from FTS file
 */
private constructor(private val m_value: Int) : FastTrackField {
    _ADATA(1),
    ACTIVITY_NAME(2),
    _FINFO(3),
    _ITMVISORDTBL(4),
    ...
    companion object {
         ...
         */
        fun getInstance(value: Int): ActivityField? {
            val result: ActivityField?
        ...
        private val MAP = arrayOfNulls<ActivityField>(IMAGE_10.m_value + 1)

        init {
            for (field in ActivityField.values()) {
