 ...
 */
internal enum class ActBarField
/**
 * Constructor.
 *
...
private constructor(private val m_value: Int) : FastTrackField {
    ...
    companion object {
         ...
         */
        fun getInstance(value: Int): ActBarField? {
            val result: ActBarField?
        ...
        private val MAP = arrayOfNulls<ActBarField>(CALCULATION_100.m_value + 1)

        init {
            for (field in ActBarField.values()) {
