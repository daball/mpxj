...
(stream: StreamReader) : TableReader(stream) {
    ...
    protected override fun readRow(stream: StreamReader, map: Map<String, Object>) {
        ...
        map.put("RESOURCE_ASSIGNMENTS", stream.readTable(ResourceAssignmentReader::class.java))
        map.put("UNKNOWN2", stream.readBytes(4))
        map.put("PREDECESSORS", stream.readTable(PredecessorReader::class.java))
        ...
        map.put("TASKS", stream.readTableConditional(TaskReader::class.java))
        map.put("COSTS", stream.readTableConditional(CostReader::class.java))
        ...
        map.put("UNKNOWN12", stream.readTable(UnknownTableReader::class.java))
