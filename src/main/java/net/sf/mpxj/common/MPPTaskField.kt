...
object MPPTaskField {
    ...
    private val MAX_VALUE = 1336

    private val FIELD_ARRAY = arrayOfNulls<TaskField>(MAX_VALUE)

    private val ID_ARRAY = IntArray(TaskField.MAX_VALUE)

    val TASK_FIELD_BASE = 0x0B400000
    /**
     ...
     */
    fun getInstance(value: Int): TaskField? {
        ...
        if (value >= 0 && value < FIELD_ARRAY.size) {
            ...
            if (value and 0x8000 != 0) {
                val baseValue = TaskField.ENTERPRISE_CUSTOM_FIELD1.getValue()
    ...
    init {
        ...
        FIELD_ARRAY[1279] = TaskField.UNAVAILABLE
        ...
        FIELD_ARRAY[1332] = TaskField.UNAVAILABLE
        FIELD_ARRAY[1335] = TaskField.UNAVAILABLE
        FIELD_ARRAY[1119] = TaskField.PHYSICAL_PERCENT_COMPLETE
        FIELD_ARRAY[1281] = TaskField.UNAVAILABLE
        ...
        FIELD_ARRAY[1282] = TaskField.UNAVAILABLE
        ...
        FIELD_ARRAY[242] = TaskField.SUBPROJECT_UNIQUE_TASK_ID
    ...
    init {
        ...
        for (loop in FIELD_ARRAY.indices) {
            val taskField = FIELD_ARRAY[loop]
            if (taskField != null) {
