...
object NumberHelper {
    ...
    val DOUBLE_ZERO = Double.valueOf(0)
    /**
    ...
    fun getInt(value: String?): Int {
        return if (value == null || value.length() === 0) 0 else Integer.parseInt(value)
    }
    ...
    fun getDouble(value: String?): Double {
        return (if (value == null || value.length() === 0) 0 else Double.parseDouble(value)).toDouble()
    }
     ...
     */
    fun getInteger(value: Number?): Integer? {
        var result: Integer? = null
        if (value != null) {
            if (value is Integer) {
                result = value as Integer?
            } else {
                result = Integer.valueOf(Math.round(value.doubleValue()) as Int)
            }
        }
        return result
    }
     ...
     * @return Integer instance
     */
    fun getInteger(value: String): Integer? {
        var result: Integer?
     ...
     */
    fun getBigInteger(value: Number?): BigInteger? {
        var result: BigInteger? = null
        if (value != null) {
            if (value is BigInteger) {
                result = value as BigInteger?
            } else {
     ...
     * @return double value
     */
    fun getDouble(value: Number?): Double {
        return (if (value == null) 0 else value.doubleValue()).toDouble()
    }
    ...
    fun getDouble(value: Double): Double {
        return if (value == 0.0) DOUBLE_ZERO else Double.valueOf(value)
    }
    ...
    fun parseInteger(value: String?): Integer? {
        return if (value == null || value.length() === 0) null else Integer.valueOf(Integer.parseInt(value))
    }
     ...
     */
    fun equals(lhs: Number?, rhs: Number?): Boolean {
        var result = false
     ...
     */
    fun compare(n1: Integer?, n2: Integer?): Int {
        val result: Int
        if (n1 == null || n2 == null) {
            result = if (n1 == null && n2 == null) 0 else if (n1 == null) 1 else -1
        } else {
     ...
     */
    fun equals(lhs: Double, rhs: Double, delta: Double): Boolean {
